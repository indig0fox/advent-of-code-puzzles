...
import (
	...
	"github.com/indig0fox/advent-of-code-puzzles/y2023d08"
	"github.com/indig0fox/advent-of-code-puzzles/y2023d09"
)
...
func run2023puzzles(results *resultsStruct) *resultsStruct {
	...
	results.Year2023 = map[string]interface{}{
		...
		"Day08": y2023d08.Run(getInputFile("08"), getLogFile("08")),
		"Day09": y2023d09.Run(getInputFile("09"), getLogFile("09")),
	}
